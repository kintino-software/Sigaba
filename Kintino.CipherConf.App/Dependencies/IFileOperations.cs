...
public interface IFileOperations
{
    ...
    /// <param name="searchPattern">The regex pattern to match file names against.</param>
    /// <returns>A collection of file paths that match the search pattern.</returns>
    public ValueTask<IEnumerable<string>> GetFilesFromDirectory(string directory, Regex? searchPattern);
    /// <summary>
