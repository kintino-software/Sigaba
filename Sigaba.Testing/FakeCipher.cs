...
public class FakeCipher : ICipher
{
    ...
    public EncryptedData EncryptWithKey(IPlainData plainData, PublicKey publicKey)
    {
    ...
    public PlainData DecryptWithKey(IEncryptedData encryptedData, PrivateKey privateKey)
    {
    ...
    public EncryptedData EncryptWithPassword(IPlainData plainData, string password)
    {
        return new EncryptedData([.. plainData.Bytes.Reverse()]);
    }

    public PlainData DecryptWithPassword(IEncryptedData encryptedData, string password)
    {
